...
│   ├── training_data/          # Roboflow datasets for fine-tuning
│   ├── detections/             # Processed media output
│   ├── train_sacks_model.py    # Factory: Script to train custom AI models
│   ├── test_main_dummy.py      # Safety: Script for automated API testing
│   └── requirements.txt
├── frontend/
│   ├── index.html              # Landing Page
│   ├── dashboard.html          # Real-time monitoring hub
